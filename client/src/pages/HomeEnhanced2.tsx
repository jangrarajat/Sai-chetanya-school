...
import { ChevronLeft, ChevronRight, GraduationCap, HelpCircle, Star } from 'lucide-react';
...
export default function HomeEnhanced() {
  ...
  const meritStudents = [
    {
      name: 'Aarav Kumar',
      achievement: 'Navodaya Selection',
      image: 'https://via.placeholder.com/150'
    },
    {
      name: 'Priya Sharma',
      achievement: 'Sainik School Selection',
      image: 'https://via.placeholder.com/150'
    },
    {
      name: 'Rohan Singh',
      achievement: 'Military School Selection',
      image: 'https://via.placeholder.com/150'
    },
    {
      name: 'Neha Patel',
    ...
    {
      name: 'Anjali Verma',
      achievement: 'National Scholarship',
      image: 'https://via.placeholder.com/150'
    },
    {
      name: 'Karan Patel',
      achievement: 'Science Olympiad',
      image: 'https://via.placeholder.com/150'
    },
    {
      name: 'Disha Singh',
      ...
      <section className="py-16 bg-gradient-to-r from-purple-50 to-blue-50">
        <div className="container mx-auto px-4">
          ...
          <div className="relative max-w-3xl mx-auto">
            ...
            <button
              onClick={prevReview}
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-12 bg-purple-600 hover:bg-purple-700 text-white p-2 rounded-full transition"
            >
              <ChevronLeft size={24} />
            </button>
            <button
              onClick={nextReview}
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-12 bg-purple-600 hover:bg-purple-700 text-white p-2 rounded-full transition"
            >
            ...
            {meritStudents.map((student, index) => (
              <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                ...
                <div className="p-4 text-center">
                  ...
                  <p className="text-sm text-purple-600 font-semibold">{student.achievement}</p>
                </div>
              </div>
            ))}
          </div>
